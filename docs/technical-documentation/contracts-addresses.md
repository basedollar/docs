...
**Deployment:** August 1, 2026

All deployed contract addresses are listed below.
...
| AeroManager | `0xE8900C7aebCa7D212717Fe2f4Df9f567e3f4d7F4` |
| RedemptionHelper | `0x438D0eDb577997898Bbef4FE1C798247d7eB5C4F` |

## Collateral Branch Contracts

There are currently 5 collateral branches: WETH, wstETH, rETH, cbBTC, and cbETH.
...
| FixedAssetReader | `0xCEC0446eBa9Eac41ccFA132f6Ee0Ee89aECFb765` |
| MetadataNFT | `0xF49fBffc26738B41869663336D4c6f82FF30470d` |
...
| GasPool | `0x6CC943f5B476B8Db11997899c517Cee467258324` |
| CollSurplusPool | `0xA304B224E332685bb741CF3D9877172e754983dd` |
| SortedTroves | `0x4f1D9102448FdE06955a6cd20D085D6b468E92AD` |
| WETHZapper | `0xCf117d9ea7f4be2C5dD5616ABB9890A21B447A84` |

### wstETH

| Contract | Address |
|---|---|
| Collateral Token | `0xc1CBa3fCea344f92D9239c08C0568f6F2F0ee452` |
...
| FixedAssetReader | `0x9f5b1832bfE4B345A6ce389311B67F4E724fd91F` |
| MetadataNFT | `0x3ad9c251D2d506D1c557F82Be5AA38B9Ed13D822` |
...
| GasPool | `0x3F0dcac8a658056bb6be30979eCb26EA7702E72d` |
| CollSurplusPool | `0xDc87cef2be8E9F7f1AD90260E5584E56835D43B3` |
| SortedTroves | `0x4dAD0339c1C33A247Fc137f44bBc5DBE8df80EE1` |
| GasCompZapper | `0x87f5a53dFfc2137Dd05070ac2970e35F7e925d28` |

### rETH

| Contract | Address |
|---|---|
| Collateral Token | `0xB6fe221Fe9EeF5aBa221c348bA20A1Bf5e73624c` |
...
| FixedAssetReader | `0xAF3db35D8ac697072d697075B4a25B4980C6bf35` |
| MetadataNFT | `0xD0B2008abDBB7452185a1F56Ae665Dfc4a91B1C2` |
...
| GasPool | `0xedF7bc788F83E17d9b62Da279db02b1bcC582262` |
| CollSurplusPool | `0x08699bD503D890ce7fD7bf216D7A6e9dA1A179E4` |
| SortedTroves | `0x637344C0634626bb5d3C8fD5CC0fB332558778f8` |
| GasCompZapper | `0xad3fe8eacF1C56E9c1A757dF8f2FB2b4f8898D35` |

### cbBTC

| Contract | Address |
|---|---|
| Collateral Token\* | `0x92a7aEE8AFaa71Ba0A9cC04A3DbE1F34237C33e0` |
...
| FixedAssetReader | `0x2fB1D8c6d9B7f61fFb69e1934b9d2BD8d0bd9651` |
| MetadataNFT | `0x0cB6C1fF5827a5246aEe464A0A55C07d7b7f49fa` |
...
| GasPool | `0x503Fef97E449D0db569155d8a1408717Ee05D363` |
| CollSurplusPool | `0xEdDcFb454F8756e992601666DF5AdB3389ef15e4` |
| SortedTroves | `0xE55530A4205Ec2eDA84adf9F5eFB2F456D5cb721` |
| WrappedTokenZapper | `0x7b465f7c3753f4a54583a34B82DB8018Ed5A24Ae` |

\* *The cbBTC branch uses an 18-decimal wrapped token of cbBTC (`wcbBTC`) to be compatible with core protocol. The underlying cbBTC token has only 8 decimals.*

### cbETH

| Contract | Address |
|---|---|
| Collateral Token | `0x2Ae3F1Ec7F1F5012CFEab0185bfc7aa3cf0DEc22` |
...
| FixedAssetReader | `0xBebAb024614A9C52e1d77AaED9Cf4E9901e41D73` |
| MetadataNFT | `0xaA6B5867F46A17ed42DeCD925C4505A02a22B08f` |
...
| GasPool | `0x4aD0D908D81c8B3F2D25ee29A1B01B31BEE781Bd` |
| CollSurplusPool | `0x2D63aE9808cfABdaB5CF6AA0202683726e46310F` |
| SortedTroves | `0x2792304889F35b60ccD79C3e173837bc6ec3AB44` |
| GasCompZapper | `0xA65CacBda151F8c23Af7BB62f771f9d5de2A3F83` |

## LP Collateral Branches

Aero LP token collateral branches have not been deployed yet. We plan to add them after Aero launches later this year.
